	//script for item specifics handling
	...
	function optionSelect(name,value){
		...
		var id = "itemSpecificValue_"+label;
	...
	function addNewSpecific(){
		...
		newElement.innerHTML = '<div style=\'padding-top: 10px;\'>'+
			'<input id=\'itemSpecificName_'+countOfEleId+'\' type=\'text\' style=\'color: gray;font: italic 900 11px verdana;\' maxlength=\'30\' name=\'itemSpecificName_'+countOfEleId+'\'/>'+
