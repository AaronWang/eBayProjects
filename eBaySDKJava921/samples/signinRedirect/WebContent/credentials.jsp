				...
				<tr>
					<td colSpan="4"><SPAN class="711530421-01042004"><FONT face="arial" size="2"> 
							...
							<font face="arial" size="2">This sample uses the new token fetch flow, For more information on Auth &amp; Auth (including 
								new token fetch flow), please refer to </font><a class="link_nav" href="#" onClick="javascript:window.open('http://developer.ebay.com/DevZone/XML/docs/WebHelp/index.htm?context=eBay_XML_API&topic=AuthNAuth');" target="_top">
