...
public enum FeatureIDCodeType {
    ...
    /**
     * 
     * 						This value is <b>deprecated</b> and should no longer be used. To verify if the seller's contact information can be shared with prospective buyers in the listing, use the 'SellerContactDetailsEnabled' enumeration value instead.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						If this value is specified, the <b>Category.EANEnabled</b> fields in the <b>GetCategoryFeatures</b> response will indicate whether or not items listed in the corresponding category may utilize EANs to identify a product. A value of 'Disabled' indicates that EANs cannot be used for the category, a value of 'Enabled' indicates that EANs can be used for the category, and a value of 'Required' indicates that an EAN is required when listing a product in this category.
     * 					
     * 
     */
    ...
    /**
     * 
     * 						If this value is specified, the <b>Category.ISBNEnabled</b> fields in the <b>GetCategoryFeatures</b> response will indicate whether or not items listed in the corresponding category may utilize ISBNs to identify a product. A value of 'Disabled' indicates that ISBNs cannot be used for the category, a value of 'Enabled' indicates that ISBNs can be used for the category, and a value of 'Required' indicates that an ISBN is required when listing a product in this category.
     * 					
     * 
     */
