 ...
 * @version 1.0
 */
public class GetCrossPromotions extends SDKTestCase {

  public void testGetCrossPromotions() throws Exception {
    ...
    api.setPromotionViewMode(TradingRoleCodeType.SELLER);

    // Make API call.
    api.getCrossPromotions();

    CrossPromotionsType cr = api.getReturnedCrossPromotion();
