...
public class AuthExample {
	...
	public static void auth() throws IOException, FlickrException {
		...
		try {
			// in =
			// AuthExample.class.getResourceAsStream("/setup.properties.example");
		...
		System.out.println(properties.getProperty("secret"));
		...
		// Token requestToken = authInterface.getAccessToken(token, new
		// Verifier(tokenKey));
