...
public class AddInventory {
	public boolean add(String fileName1, String fileName2) {
		...
		if(!rw.Write("result " + fileName1, wb)) {
			return false;
		}
		if(!rw.Write("result " + fileName2, wb2))//sold left
			return false;
		return true;
	}
}
